...
1. When prompted, enter the following information:
	...
	c. Name of the mp4 file to be generated
...
Note: Other settings can be changed in the settings.py file to modify the appearance of the overlaid text.


** Requirements **
ffmpeg
Python 2.7 (see requirements.txt for python dependencies)
